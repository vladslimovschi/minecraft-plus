...
public enum ModItemTier implements Tier {
    SUPER(5, 20000, 10.7f, 14.8f, 500, () -> Ingredient.of(Items.NETHERITE_BLOCK));
    ...
    public net.minecraft.tags.TagKey<net.minecraft.world.level.block.Block> getTag() { return null; }
}
